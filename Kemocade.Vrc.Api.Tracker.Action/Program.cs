...
using Vrc.Api.Tracker.Action;
using VRChat.API.Api;
using VRChat.API.Client;
using VRChat.API.Model;
using static Vrc.Api.Tracker.Action.TrackedData;
using static Vrc.Api.Tracker.Action.TrackedData.TrackedVrcGroup;
...
TrackedData data = new()
{
    ...
    VrcWorldsById = vrcWorldIdsToWorldModels.ToDictionary(
        kvp => kvp.Key,
